//Approach-2
//T.C : The overall time complexity is O(log N) 
// for the addNum method and O(1) for the findMedian method.
//S.C : O(N).
public class MedianFinder {
    ...
    public void addNum(int num) {
        ...
        // always maintain leftMaxHeap size one greater
        // than rightMinHeap size or both sizes equal
